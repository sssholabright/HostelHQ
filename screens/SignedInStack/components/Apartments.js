        ...
        <SafeAreaView style={{flex: 1, backgroundColor: 'white'}}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 20}}>
                    ...
                    <Text style={{color: '#003366', fontSize: 18, fontWeight: '600', paddingHorizontal: 20}}>Apartments</Text>
                    <View />
                </View>
                <View style={{flexDirection: 'row', justifyContent: 'center', alignItems: 'center', padding: 5, borderWidth: 1, borderColor: 'lightgray', marginHorizontal: 20, borderRadius: 25}}>
                    <View style={{flexDirection: 'row', justifyContent: 'center', alignItems: 'center', padding: 5, borderWidth: 1, width: 80, borderColor: 'lightgray', marginHorizontal: 20, borderRadius: 25}}>
                    ...
                    <View style={{flexDirection: 'row', justifyContent: 'center', alignItems: 'center', padding: 5, borderWidth: 1, width: 80, borderColor: 'lightgray', marginHorizontal: 20, borderRadius: 25}}>
                        ...
                        <Text style={{color: '#003366', fontSize: 15}}>Filter</Text>
                    </View>
                </View>
                <View>
